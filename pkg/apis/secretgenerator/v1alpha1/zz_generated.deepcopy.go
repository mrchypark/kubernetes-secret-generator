...
func (in *BasicAuthStatus) DeepCopyInto(out *BasicAuthStatus) {
	*out = *in
	in.CommonSecretStatus.DeepCopyInto(&out.CommonSecretStatus)
}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *CommonSecretStatus) DeepCopyInto(out *CommonSecretStatus) {
	*out = *in
	if in.Secret != nil {
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new CommonSecretStatus.
func (in *CommonSecretStatus) DeepCopy() *CommonSecretStatus {
	if in == nil {
		return nil
	}
	out := new(CommonSecretStatus)
	in.DeepCopyInto(out)
	return out
}
