# v4.0.0-rc.12 production-readiness directive

## Goal

Ship a reviewable `v4.0.0-rc.12` candidate with safe migration tooling and clear rollback.
...
The following are deliberately not per-release blockers for `v4.0.0-rc.12`: automated
