...
export IMAGE_DIGEST='sha256:<64-hex-digest-from-v4.0.0-rc.10-candidate>'
...
`v4.0.0-rc.10` is a digest-addressed candidate for amd64 and arm64. It carries no SLA,
